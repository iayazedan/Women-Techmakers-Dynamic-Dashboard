                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Add New</strong> Sponser
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="scripts/sponser.php" method="post" enctype="multipart/form-data" class="form-horizontal">

                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="title" class=" form-control-label">Sponser Name</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="title" name="sponserName" placeholder="Sponser Name" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="file-input" class=" form-control-label">Sponser Logo</label>
                                                </div>
                                                <div class="col-12 col-md-9">
